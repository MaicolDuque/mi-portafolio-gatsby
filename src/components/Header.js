  ...
  <header className="bg-white border-solid border-b-2 ">
    <div className="container mx-auto p-12 max-w-6xl ">
      ...
      <div className="flex justify-center mt-5">      
        <a href="https://github.com/MaicolDuque" target="_blank" className="mr-3">
          <FontAwesomeIcon icon={faGithub} size="2x" cursor="pointer"/>
        </a>
        <a href="https://twitter.com/maicolduque24" target="_blank" className="mr-3">
          <FontAwesomeIcon icon={faTwitter} size="2x" cursor="pointer" />
        </a>
        <a href="https://www.linkedin.com/in/maicolduque/" target="_blank" className="mr-3">
